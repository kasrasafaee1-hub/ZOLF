    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('reverse-lunge', 'Reverse lunge', 'glutes', 2, 6, 8, 'volume', 90, { cue: 'Long step, drive through the heel', perSide: true }),
        ],
      },
      {
        id: 'full',
        ...
        patron: 'Olympus',
        exercises: [
          ex('heavy-choice-b', 'Heavy front squat or trap-bar deadlift (pick 1)', 'quads', 2, 6, 8, 'strength', 180, { cue: 'Max strength, no grind reps' }),
          ex('chin-up', 'Chin-up', 'back', 2, 6, 8, 'volume', 120, { cue: 'Supinated grip, biceps get a share' }),
          ex('seated-row', 'Seated cable row', 'back', 2, 6, 8, 'volume', 90, { cue: 'Full stretch, controlled pull' }),
          ex('arnold-press', 'Arnold press', 'shoulders', 2, 6, 8, 'volume', 90, { cue: 'Rotate through the whole range' }),
